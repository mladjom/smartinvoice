<div class="row">
    <div class="col-md-3">
        <div class="form-group {{{ $errors->has('logo') ? 'has-error' : '' }}}">
            ...
            <p class="small">{{ Lang::get('clients.help.logo') }}</p>
    ...
    <div class="col-md-9">
        ...
        <div class="form-group {{{ $errors->has('name') ? 'has-error' : '' }}}">
            ...
            <input class="form-control" type="text" name="name" id="client_name" placeholder="{{ Lang::get('clients.placeholder.name') }}" value="{{{ Input::old('name', isset($client) ? $client->name : null) }}}" />
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group {{{ $errors->has('email') ? 'has-error' : '' }}}">
                    ...
                    <input class="form-control" type="text" name="email" id="client_email" placeholder="{{ Lang::get('clients.placeholder.email') }}" value="{{{ Input::old('email', isset($client) ? $client->email : null) }}}" />
        ...
        <div class="form-group">
            <div class="controls pull-right">
                <a class="btn btn-link" data-dismiss="modal" href="{{{ URL::to('clients') }}}">{{ Lang::get('general.cancel') }}</a>
                <button type="submit" id="save-client" class="btn btn-success btn-lg">{{ Lang::get('general.save') }}</button>
            </div>
        </div>
        <!-- ./ form actions --> 
    </div>
